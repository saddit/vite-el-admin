...
<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit space-y-6">
        <div class="bullshit__oops">ViteEl后台管理系统</div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">
          你是不是输错地址了？点击下面的按钮回首页吧
        </div>
        <a href="/" class="bullshit__return-home ml-20">返回首页</a>
      </div>
    </div>
  </div>
</template>
